...
CATEGORIES = ['Food', 'Travel', 'Entertainment', 'Utilities', 'Healthcare', 'Others']
...
def add_expense(expenses):
    ...
    # Display category list that user can select single or multiple categories
    print("Select one or more categories from the options given (separate choices by commas 'Ex: 1,2,3'):")
